            ...
            <div class="card" style="border-radius: 15px;">
              <div class="card-body p-5">
                ...
                <form action="student_data_check.php" method="post">
                  ...
                  <p class="text-center text-muted mt-5 mb-0">Have already an account? <a href="./login.php" class="fw-bold text-body"><u>Login here</u></a><a href="./home.php" class="fw-bold text-body"><br><u> HOME </u></a></p>
                </form>
