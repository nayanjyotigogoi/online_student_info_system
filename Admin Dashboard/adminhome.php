...
<body>
	...
	<aside class="leftBox">
		...
		<ul>
			...
			<li>
				<a href="./add student/add_student.php">Add Student</a>
			</li>

			<li>
				<a href="./view student/view_student.php">View Student</a>
			</li>


			<li>
				<a href="./view complaint/view_complaint.php">View Complaint</a>
			</li>

			<li>
				<a href="./room/room.php">Rooms Details</a>
			</li>

			<li>
				<a href="./room/Add_room.php">Add room</a>
			</li>

			<li>
				<a href="./view receipt/View_receipt.php">View receipt</a>
			</li>
