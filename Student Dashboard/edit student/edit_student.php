                                        ...
                                        <div class="col-md-5 border-right student-profile-form-box">
                                            <div class="p-3 py-5">
                                                ...
                                                <div class=" col-md-6">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="surname" name="surname" value="<?php echo $userInfo['surname']; ?>" required>
                                                    </div>
                                                </div>
                                                <div class="row mt-3">
                                                    <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="row mt-3">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                value="<?php echo $userInfo['country']; ?>" name="country" required>
                                                            </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="enter Gsuite-id" value="<?php echo $userInfo['gsuite']; ?>" name="gsuite" required>
                                                    </div>
